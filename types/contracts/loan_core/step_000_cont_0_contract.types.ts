...
type Methods = {
  ...
  whitelist_currency: (currency: address, precision: nat) => Promise<void>;
};
...
type MethodsObject = {
  ...
  whitelist_currency: (params: { currency: address; precision: nat }) => Promise<void>;
};
...
type contractTypes = {
  ...
  storage: Storage;
  code: { __type: 'ContractsLoanCoreStep000Cont0ContractCode'; protocol: string; code: object[] };
};
export type ContractsLoanCoreStep000Cont0ContractContractType =
  ContractAbstractionFromContractType<contractTypes>;
export type ContractsLoanCoreStep000Cont0ContractWalletType =
