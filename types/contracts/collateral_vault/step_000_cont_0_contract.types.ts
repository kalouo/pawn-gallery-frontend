...
type Methods = {
  ...
  withdraw: (deposit_id: nat, recipient: address) => Promise<void>;
};
...
type MethodsObject = {
  ...
  withdraw: (params: { deposit_id: nat; recipient: address }) => Promise<void>;
};
...
export type ContractsCollateralVaultStep000Cont0ContractContractType =
  ContractAbstractionFromContractType<contractTypes>;
export type ContractsCollateralVaultStep000Cont0ContractWalletType =
