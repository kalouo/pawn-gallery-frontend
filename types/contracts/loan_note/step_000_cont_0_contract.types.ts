...
type contractTypes = {
  ...
  storage: Storage;
  code: { __type: 'ContractsLoanNoteStep000Cont0ContractCode'; protocol: string; code: object[] };
};
export type ContractsLoanNoteStep000Cont0ContractContractType =
  ContractAbstractionFromContractType<contractTypes>;
export type ContractsLoanNoteStep000Cont0ContractWalletType =
